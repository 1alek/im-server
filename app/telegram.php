...
class Telegram
{
	...
	if ($_CONFIG['messenger']['telegram']['use_proxy'] == 1 ) {
    	    //$proxy = 'socks5://82261428:5PNDaTbT@185.211.245.142:1090';
	    curl_setopt($ch, CURLOPT_PROXYTYPE, CURLPROXY_SOCKS5);
	    curl_setopt($ch, CURLOPT_PROXY, $_CONFIG['messenger']['telegram']['proxy']);
	}
